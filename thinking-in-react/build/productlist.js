...
var SearchBar = React.createClass({
	...
	render: function () {
		return React.createElement(
			"form",
			null,
			React.createElement("input", { type: "text", placeholder: "Search...", value: this.props.filterText, ref: "filterText", onChange: this.onChange }),
			React.createElement(
				"p",
				null,
				React.createElement("input", { type: "checkbox", value: this.props.inStockOnly, ref: "inStockOnly", onChange: this.onChange }),
				' ',
